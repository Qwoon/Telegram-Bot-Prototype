...
public class SqlMigrationsScaffolder : MigrationsScaffolder
{
    ...
    /// <inheritdoc/>
    public override ScaffoldedMigration ScaffoldMigration(string migrationName, string? rootNamespace, string? subNamespace = null)
    {
        ...
        return base.ScaffoldMigration(migrationName, rootNamespace, subNamespace);
    }
